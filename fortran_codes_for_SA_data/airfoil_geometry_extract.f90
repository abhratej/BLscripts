program airfoilgeometry
    ...
    !--------------------------------------------------------------------------------------------------------------------
    ! "Pressure" "Velocity:0" "Velocity:1" "Velocity:2" "Nu_Tilde" "Pressure_Coefficient" "Density" "Laminar_Viscosity" |
    ! "Skin_Friction_Coefficient:0" "Skin_Friction_Coefficient:1" "Skin_Friction_Coefficient:2" "Heat_Flux" "Y_Plus"    |
    ! "Eddy_Viscosity" "Points:0" "Points:1" "Points:2"                                                                 |
    !--------------------------------------------------------------------------------------------------------------------
    ...
    do i=1,npoints
        if ( io .ne. 0 ) exit 
        read (fu,*,iostat=io) temp, temp, temp, temp, temp, temp, temp, temp, temp, temp, temp, temp, temp, temp,&
