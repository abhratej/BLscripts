...
flowvtk = LegacyVTKReader(
	FileNames=['/home/abhratej/github/BLscripts/flow.vtk'])

# Read airfoil and normal data
with open('/home/abhratej/github/BLscripts/output/airfoil_normals.txt') as airfoilData:
...
for i in range(0, len(airfoilCoord), 1):
	...
	# save data
	SaveData('/home/abhratej/github/BLscripts/output/normalflowfields/flow_along_normal_point'+str(i+1)+'.tsv', proxy=calculator2, Precision=8, UseScientificNotation=1, FieldDelimiter='\t')
